...
class Cpmg15NIpSettings(CpmgSettings):
    """Settings for in-phase 15N CPMG relaxation dispersion experiment."""
...
class Cpmg15NIpSequence:
    """Sequence for in-phase 15N CPMG relaxation dispersion experiment."""

    def __init__(self, settings: Cpmg15NIpSettings) -> None:
...
def create_profile_calculation(
    ...
    return ProfileCalculation(
        ...
        pulse_sequence=Cpmg15NIpSequence(config.experiment),
    )
