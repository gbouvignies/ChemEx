...
parse_line = "15N - Pure In-phase Nitrogen CEST (3 state, fast) [experimental]"

description = """\
Analyzes 15N chemical exchange in the presence of 1H composite decoupling during
the CEST block. This keeps the spin system purely in-phase throughout, and is 
calculated using the 9x9, single spin matrix:
