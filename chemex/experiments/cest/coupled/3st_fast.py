"""Pure in-phase CEST in uniformly C13-labeled samples (3-state, fast)
...
class Profile(base_profile.BaseProfile):
    ...
    def create_default_parameters(self):
        ...
        parameters.add_many(
            ...
            (self.map_names['dlambda_i_ac'], 0.0, True, None, None, None),
            ...
            if b1_offset <= -1.0e+04:
                ...
                for j, weight in self.multiplet:
                    liouvillian = compute_liouvillian(
                        ...
                        lambda_i_b=lambda_i_a + dlambda_i_ab, rho_i_b=rho_i_a, omega_i_b=omega_i_a + domega_i_ab + j,
                        lambda_i_c=lambda_i_a + dlambda_i_ac, rho_i_c=rho_i_a, omega_i_c=omega_i_a + domega_i_ac + j,
                        omega1x_i=omega1x_i
                    )
