...
class Profile(base_profile.BaseProfile):
    ...
    def __init__(self, profile_name, measurements, exp_details):
        ...
        self.ppm_i = (self.h_larmor_frq * 2.0 * np.pi *
                      constants.xi_ratio[self.resonance_i['atom']])
        self.ppm_s = (self.h_larmor_frq * 2.0 * np.pi *
                      constants.xi_ratio[self.resonance_s['atom']])
