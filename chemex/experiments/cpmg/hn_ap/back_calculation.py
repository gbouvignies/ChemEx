...
def make_calc_observable(pw=0.0, time_t2=0.0, time_equil=0.0, ppm_to_rads=1.0, carrier=0.0,
    ...
    of exchange after a CPMG block with 'antiphase_flg' set to 'y'.
    ...
    @lru_cache(100)
    def _calc_observable(pb=0.0, kex=0.0, dw=0.0, r_hxy=5.0, dr_hxy=0.0, r_nz=1.5,
