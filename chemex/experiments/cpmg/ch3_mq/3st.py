"""1H-13C(methyl) - Multiple Quantum CPMG (3-state)
...
from chemex.bases import mq_3st, util as bases_util
...
compute_liouvillian = mq_3st.compute_liouvillian
p_180x_i = mq_3st.p_180x_i
p_180y_i = mq_3st.p_180y_i
p_180x_s = mq_3st.p_180x_s
p_180y_s = mq_3st.p_180y_s
...
class Profile(base_profile.BaseProfile):
    ...
    def create_default_parameters(self):
        ...
        parameters.add_many(
            ...
            (self.map_names['dw_s_ac'], 0.0, True, None, None, None),
            (self.map_names['lambda_mq_a'], 10.0, True, 0.0, None, None),
            (self.map_names['dlambda_mq_ab'], 0.0, False, None, None, None),
            (self.map_names['dlambda_mq_ac'], 0.0, False, None, None, None),
            (self.map_names['mu_mq_a'], 0.0, False, 0.0, None, None),
        )

        return parameters

    def _calculate_profile(self, pb, pc, kex_ab, kex_bc, kex_ac, dw_i_ab, dw_i_ac, dw_s_ab, dw_s_ac,
                           lambda_mq_a, dlambda_mq_ab, dlambda_mq_ac, mu_mq_a):
        ...
        omega_i_c = dw_i_ac * self.ppm_to_rads_i
        omega_s_a = 0.0
        omega_s_b = dw_s_ab * self.ppm_to_rads_s
        omega_s_c = dw_s_ac * self.ppm_to_rads_s
        lambda_mq_b = dlambda_mq_ab
        lambda_mq_c = dlambda_mq_ac
        ...
        kwargs = {
            ...
            'omega_i_c': omega_i_c, 'omega_s_c': omega_s_c, 'lambda_mq_c': lambda_mq_c, 'mu_mq_c': mu_mq_a,
        }
