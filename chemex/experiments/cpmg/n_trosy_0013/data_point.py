...
PAR_DICT = {
    ...
    'par_conv': ((str, ('resonance_id', 's3e_flg', 'antitrosy_flg',)),
    ...
    'exp': ('resonance_id', 'h_larmor_frq', 'temperature', 'carrier',
            'time_t2', 'time_equil', 'pw', 'taub', 'ncyc', 'ncyc_max', 
            's3e_flg', 'antitrosy_flg'),
...
class DataPoint(BaseDataPoint):
    ...
    def __repr__(self):
        ...
        output.append('{s3e_flg:3s}'.format(**self.par))
        output.append('{antitrosy_flg:3s}'.format(**self.par))
