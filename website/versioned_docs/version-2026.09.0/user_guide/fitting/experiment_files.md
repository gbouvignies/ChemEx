...
:::note
Each experiment available in ChemEx includes a sample configuration file, which details available key-value pairs. These samples are found in the [Experiments](../../experiments/index.mdx) section.
:::
