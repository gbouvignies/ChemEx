...
Each deterministic factor filename identifies its concrete grid axes. Its TSV
contains the coordinate values, profiled chi-square, point status, selected
flag, objective-evaluation count, and a failure description when applicable.
