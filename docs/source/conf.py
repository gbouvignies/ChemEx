...
project = u'ChemEx'
copyright = u'2020, Guillaume Bouvignies'
author = u'Guillaume Bouvignies'
...
latex_documents = [
    ('index', 'chemex.tex', 'ChemEx Documentation',
     author, 'manual')
]
...
texinfo_documents = [
    ('index', 'chemex', 'ChemEx Documentation', author,
     'ChemEx', 'ChemEx Documentation.', 'Miscellaneous'),
]
